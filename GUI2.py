    ...
    def get_input_device(self):
        ...
        try:
            ...
            if device_info:
                ...
                print(f"[AUDIO] Bound to Default Input Device '{device_info['name']}' @ {native_sr}Hz")
        except Exception as e:
            print(f"Device scan error: {e}")

        # Returning None instructs sounddevice to use the system default without forcing an API
